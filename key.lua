...
function MakeScriptHub()
         loadstring(game:HttpGet('https://raw.githubusercontent.com/githubscripting/TridentSurvival.v0.1/main/menu.lua'))() --Put The Script That Will Load If The Key Is Correct Here
end
...
getgenv().Key = "232232i324324di89834te93u38bfbsdghbdfh" --Put The Correct Key Here
