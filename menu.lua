...
------------------------------
Tab:AddButton({ Name = "ESP&hitbox Big(medium=7 zxy; possible ban)", Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/githubscripting/TridentSurvival.v0.1/main/HB-body-big.lua", true))() end })
------------------------------
